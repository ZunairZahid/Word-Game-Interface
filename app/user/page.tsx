  ...
  export default function page() {
    return (  
      ...
      <div className='bg-white rounded-2xl border-t-4 border-blue-500 w-full max-w-[2160px] absolute' >
        <div className=' flex items-center bg-transparent justify-center mb-10'>
          <div className=' text-white bg-blue-500 rounded-3xl p-2 text-3xl font-bold font-poppins absolute text-center '>
            Your Score
          </div>
        </div>
